...
const Footer = () => {
  return (
    <footer className="bg-black border-t border-crypto-gray">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="http://medium.com/@mericulum" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-crypto-blue transition-colors">
